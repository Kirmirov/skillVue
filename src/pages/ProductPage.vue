		...
		<section class="item">
			<div class="item__pics pics">
				<div class="pics__wrapper">
					<img width="570" height="570" :src="product.img" :alt="product.name">
				</div>
			</div>

			<div class="item__info">
				<span class="item__code">{{ product.id + '0' + product.categoryID + '0' + product.colorID }}</span>
				...
				<div class="item__form">
					<form class="form" action="#" method="POST" @submit.prevent="addToCart">
						...
						<div class="item__row">
							<CounterH :counterStart.sync="productAmount"/>
